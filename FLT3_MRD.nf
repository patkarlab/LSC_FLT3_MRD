...
//gen_ref = file("${params.gen_ref}", checkIfExists:true)
...
workflow FLT3_MRD {
	...
	ANNOVAR(VARSCAN.out.join(FILT3R.out.filt3r_vcf))
	//ANNOVAR(VARSCAN.out.join(FILT3R.out.filt3r_vcf), annovar_humandb)
